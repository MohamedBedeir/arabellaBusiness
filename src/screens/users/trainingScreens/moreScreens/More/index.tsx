  ...
  const bodySection = () => {
    return (
      <View style={styles.body}>
        <View>
          <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Profile'})}
          ...
          />
          {/* <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Branches'})}
          ...
          /> */}
          {/* <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Employees'})}
          ...
          /> */}
          {/* <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Services'})}
          ...
          /> */}
          {/* <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Offers'})}
          ...
          /> */}
          <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_BlockAppointments'})}
          ...
          />
          {/* <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Accounts'})}
          ...
          /> */}
          <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Language'})}
          ...
          />
          {/* <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_Ratings'})}
          ...
          /> */}
          <MoreItem
            onPress={() => navigation.navigate('TR_MoreDetailsStack', {screen: 'TR_TermsAndConditions'})}
