...
const Home: React.FC = () => {
  ...
  const headerSection = () => {
    ...
    return (
      <AppHeaderAdvanced
        user={user}
        onPress1={() => navigation.navigate('SM_HomeDetailsStack', {screen: 'SM_Notifications'})}
        onPress2={() => navigation.navigate('SM_MoreDetailsStack', {screen: 'SM_Profile'})}
