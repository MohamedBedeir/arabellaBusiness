export default {
  ...
  signIn: 'sign in',
  doWantLogout: 'Do you want to log out?',
  ...
  haveNotBlockedAnyAppointmentsYet: 'You have not blocked any appointments yet',
  haveNotAddedAnyServicesYet: 'You have not added any services yet',
