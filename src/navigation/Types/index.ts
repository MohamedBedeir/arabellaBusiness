export type IntroductionStackParam = {
  Splash: undefined;
  Definition: undefined;
  LetsStart: undefined;
};

export type AuthenticationStackParam = {
  SignUp: undefined;
  Login: undefined;
...
export type MA_HomeDetailsStackParam = {
  MA_Notifications: undefined;
};
export type MA_MoreStackParam = {
  MA_More: undefined;
};
